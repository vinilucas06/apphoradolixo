...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@ionic-native/geolocation/__ivy_ngcc__/ngx/index.js"); // import { FirebaseX } from '@ionic-native/firebase-x/ngx';
    //import { FCM } from '@ionic-native/fcm/ngx';


    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(platform, splashScreen, statusBar, router, routerComponent, auth, iab, // public firebaseX: FirebaseX,
      ...
      _createClass(AppComponent, [{
        ...
        value: function initializeApp() {
          ...
          this.platform.ready().then(function () {
            ...
            _this.iniciarListenerDeNotificacoes();
        ...
        value: function sair() {
          ...
          if (this.usuario.user_id != 741) {
            ...
            this.menuCtrl.toggle(); //App.exitApp();
        ...
        key: "inializeFCM",
        value: function inializeFCM() {// // this.firebase.getToken().then(token => {alert(token); this.token = token;});
        ...
        key: "solicitarTokenDoFirebase",
        value: function solicitarTokenDoFirebase() {
          var _this3 = this;

          this.firebase.getToken().then(function (token) {
            _this3.iniciarListenerDeNotificacoes();
        ...
        key: "iniciarListenerDeNotificacoes",
        value: function iniciarListenerDeNotificacoes() {
          var _this4 = this;

          this.firebase.onNotificationOpen().subscribe(function (notification) {
            _this4.presentAlert(notification.title, notification.body);
          });
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _modals_esqueceusenha_esqueceusenha__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    ...
    var _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! @ionic-native/firebase/ngx */
    "./node_modules/@ionic-native/firebase/__ivy_ngcc__/ngx/index.js");
    /* harmony import */
    ...
    "./node_modules/@fortawesome/free-solid-svg-icons/index.es.js"); //import { FirebaseX } from "@ionic-native/firebase-x/ngx";
        ...
        value: function getLocation() {
          ...
          this.geolocation.getCurrentPosition().then(function (resp) {
            ...
            _this7.geocoder.geocode({
              ...
              if (status === "OK") {
                var model = {
                  user_id: _this7.usuario.user_id,
                ...
                _this7.usuarioService.CadastrarEndereco(model).subscribe(function (data) {
                  _this7.presentAlert("Cadastrado com sucesso.");

                  _this7.dismissModal();
                }); //console.log(results[0].formatted_address);

              } else {
                _this7.presentAlert("Não econtramos seu endereço digite seu cep.");
              }
            });
          })["catch"](function (error) {
            _this7.presentAlert("Erro : " + error);
          });
        }
      }, {
        key: "presentAlert",
    ...
    var EsqueceuSenhaModal = /*#__PURE__*/function () {
      ...
      _createClass(EsqueceuSenhaModal, [{
        ...
        value: function esqueceuSenha(form) {
          ...
          this.dismissModal(); // this.authenticationService.EsqueceuSenha(form.email).subscribe(
          //     res => {
  ...
  function srcAppPagesLoginLoginTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/modals/esqueceusenha/esqueceusenha.ts"); // import { FirebaseX } from '@ionic-native/firebase-x/ngx';
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Lucas\Documents\Projetos\hora-do-lixo\app2\ios\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
